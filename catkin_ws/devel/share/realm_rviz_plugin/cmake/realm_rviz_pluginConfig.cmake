...
if(NOT "/usr/local/include;/usr/local/include/opencv;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realm_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zeeco/OpenREALM/catkin_ws/src/OpenREALM_ROS1_Bridge/realm_rviz_plugin/${idir}'.  ${_report}")
    endif()
